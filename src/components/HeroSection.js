				...
				<Row>
					...
					<Col>
						<div>
							...
							<p>
								available on any device which can be connected to the internet
							</p>
						</div>
					</Col>
				</Row>
				...
				<Row>
					...
					<Col>
						<div>
							...
							<br />
							<p>
								The secure platform ensures that the results directly reflect
								the
							</p>
				...
				<Row>
					<Col>
						<div className='descImages'>
							<img
								src={security}
								alt='security2.png'
								/*className="descImages"*/ height='50%'
								width='50%'
							/>
						</div>
					</Col>
					<Col>
						<div>
							...
							<br />
							<p>
								Blockchain technology ensures that the election data stored
								cannot
							</p>
